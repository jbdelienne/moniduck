...
const tiers: Tier[] = [
  {
    ...
    features: [
      ...
      { text: "Cloud accounts", ok: false },
      { text: "Slack & webhooks", ok: false },
      { text: "Status page", ok: false },
      { text: "SLA reports", ok: false },
    ],
  },
  {
    name: "Startup",
    ...
    features: [
      ...
      { text: "Email + Slack alerts", ok: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Custom check interval (down to 30s)", ok: true },
      { text: "Custom data retention", ok: true },
      { text: "SSO / SAML", ok: true },
      { text: "Dedicated Slack support channel", ok: true },
